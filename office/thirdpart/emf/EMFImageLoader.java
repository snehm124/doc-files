...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.emf.data.BitmapInfoHeader;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
