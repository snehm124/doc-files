...
package com.documentreader.docs.pdf.word.document.reader.viewer.office.res;
...
public class ResKit
{
    ...
    public ResKit()
    {
        try
        {
            ...
            // load "ResConstant"
            Class cls = Class.forName("com.documentreader.docs.pdf.word.document.reader.viewer.office.res.ResConstant");
            // get all fields
