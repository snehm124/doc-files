...
package com.documentreader.docs.pdf.word.document.reader.viewer.office.system;

import java.io.File;

import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bookmark.BookmarkManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.BordersManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bulletnumber.ListManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.hyperlink.HyperlinkManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.picture.PictureManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.animate.AnimationManager;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.model.PGBulletText;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.system.beans.CalloutView.CalloutManager;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.control.WPShapeManage;
...
public class SysKit {
    ...
    public static Drawable getPageNubmerDrawable() {
        if (pageNumberDrawable == null) {
            pageNumberDrawable = new ShapeDrawable(new RoundRectShape(new float[]{10, 10, 10, 10,
                    10, 10, 10, 10}, null, null));
            pageNumberDrawable.getPaint().setColor(Color.GRAY);
        }
