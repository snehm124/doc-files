 ...
 * 时间:              上午9:08:14
 */
package com.documentreader.docs.pdf.word.document.reader.viewer.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
