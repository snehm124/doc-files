...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
