 ...
 * 时间:              下午1:55:20
 */
package com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.XLSModel;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.AChart;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.constant.SSConstant;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.model.InternalSheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.model.InternalWorkbook;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.BlankRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.CellValueRecordInterface;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.DefaultRowHeightRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.RecordBase;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.RowRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFAutoShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFChart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFFreeform;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFLine;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFPatriarch;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFPicture;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFPictureData;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFRichTextString;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFSheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFTextbox;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFWorkbook;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.HSSFPaneInformation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.util.HSSFCellRangeAddress;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.xls.ChartConverter;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Rectangle;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.CellRangeAddress;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.Cell;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.Row;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.Sheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.Workbook;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.drawing.AnchorPoint;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.drawing.CellAnchor;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.sheetProperty.PaneInformation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.util.ModelUtil;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.util.SectionElementFactory;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.chart.RoundChart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.chart.XYChart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.sheetProperty.ColumnInfo(
