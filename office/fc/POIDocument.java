...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.DocumentSummaryInformation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.MutablePropertySet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.PropertySet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.PropertySetFactory;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.SummaryInformation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.DirectoryEntry;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.DirectoryNode;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.DocumentInputStream;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.Entry;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hpsf.WritingNotSupportedException wnse)
        {
