 ...
 * 时间:               下午4:23:51
 */
package com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ppt;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.PaintKit;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.autoshape.ExtendPath;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bg.BackgroundAndFill;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bg.Gradient;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bg.LinearGradientShader;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bg.RadialGradientShader;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bg.TileShader;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.hyperlink.Hyperlink;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.pictureefftect.PictureEffectInfoFactory;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.AbstractShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.ArbitraryPolygonShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.Arrow;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.AutoShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.GroupShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.IShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.LineShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.PictureShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.ShapeTypes;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.TableCell;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.TableShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.TextBox;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.constant.AutoShapeConstant;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.constant.wp.WPAttrConstant;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.constant.wp.WPModelConstant;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.FCKit;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ShapeKit;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.HSLFSlideShow;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Fill;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.HeadersFooters;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Line;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.MasterSheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Notes;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Shape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.ShapeGroup;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Sheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.SimpleShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Slide;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.SlideMaster;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TextShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TitleMaster;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.BinaryTagDataBlob;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.ClientVisualElementContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.DocumentAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.OEPlaceholderAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.PositionDependentRecordContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Record;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.SlideAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.SlideProgTagsContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeNodeContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TimeVariant;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.VisualShapeAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.usermodel.PictureData;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.usermodel.RichTextRun;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.usermodel.SlideShow;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ppt.bulletnumber.BulletNumberManage;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Rectanglef;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.geom.Rectangle2D;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.animate.ShapeAnimation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.model.PGModel;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.model.PGNotes;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.pg.model.PGSlide;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.font.FontTypefaceManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.AttrManage;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.IAttributeSet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.LeafElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.ParagraphElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.SectionElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.util.format.NumericFormatter;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.system.AbstractReader;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.system.BackReaderThread;
...
{   
    ...
    private com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Freeform
            || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.AutoShape
            || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TextBox
            || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.AutoShape
                    || shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Picture)
            {   
                com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Picture poiPic = (com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Table)
        {
            com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Table poiTable = (com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
