...
package com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.doc;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bookmark.Bookmark;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Border;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Borders;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.borders.Line;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bulletnumber.ListData;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.bulletnumber.ListLevel;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.hyperlink.Hyperlink;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.picture.Picture;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.WPAbstractShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.WPAutoShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.WPGroupShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.common.shape.WPPictureShape;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherContainerRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherOptRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherProperties;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherSimpleProperty;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherTextboxRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.HWPFDocument;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.FieldsDocumentPart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.ListFormatOverride;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.ListTables;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.POIListData;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.POIListLevel;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.model.PicturesTable;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Bookmarks;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.BorderCode;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.CharacterRun;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Field;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.HWPFShape;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.HeaderStories;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.InlineWordArt;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.OfficeDrawing;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.OfficeDrawings;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.POIBookmark;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Paragraph;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.PictureType;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Range;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Section;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Table;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.TableCell;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.TableRow;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.util.LittleEndian;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Rectangle;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.java.util.Arrays;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.model.IElement;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.simpletext.view.PageAttr;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.util.ModelUtil;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.model.CellElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.model.HFElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.model.RowElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.model.TableElement;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.documentreader.docs.pdf.word.document.reader.viewer.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
