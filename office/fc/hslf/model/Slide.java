...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.ColorSchemeAtom;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hslf.record.Slide)getSheetContainer();
    }
