 ...
 * 时间:              下午2:21:40
 */
package com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.xls;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFCell;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFChart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFDataFormat;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFFormulaEvaluator;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFName;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFChart.HSSFChartType;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFChart.HSSFSeries;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.XLSModel.ARow;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.XLSModel.ASheet;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.style.CellStyle;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.util.format.NumericFormatter;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.ChartFactory;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.chart.AbstractChart;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.chart.PointStyle;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.chart.ColumnBarChart.Type;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.model.CategorySeries;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.model.XYMultipleSeriesDataset;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.model.XYSeries;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.renderers.DefaultRenderer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.renderers.SimpleSeriesRenderer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.renderers.XYSeriesRenderer;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.thirdpart.achartengine.util.MathHelper;
