...
package com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.model;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherBSERecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherBoolProperty;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherContainerRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherDgRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherDggRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherRGBProperty;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherSimpleProperty;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherSpRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherSplitMenuColorsRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.FormulaShifter;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.ptg.Area3DPtg;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.ptg.NameXPtg;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.ptg.OperandPtg;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.ptg.Ptg;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.ptg.Ref3DPtg;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.udf.UDFFinder;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.BOFRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.BackupRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.BookBoolRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.BoundSheetRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.CodepageRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.CountryRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.DSFRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.DateWindow1904Record;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.DrawingGroupRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.EOFRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.EscherAggregate;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.ExtSSTRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.ExtendedFormatRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.ExternSheetRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.FileSharingRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.FnGroupCountRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.FontRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.FormatRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.HideObjRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.HyperlinkRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.InterfaceEndRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.InterfaceHdrRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.MMSRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.NameCommentRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.NameRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.PaletteRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.PasswordRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.PasswordRev4Record;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.PrecisionRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.ProtectRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.ProtectionRev4Record;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.RecalcIdRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.Record;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.RefreshAllRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.SSTRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.StyleRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.SupBookRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.TabIdRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.UseSelFSRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.WindowOneRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.WindowProtectRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.WriteAccessRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.WriteProtectRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.common.UnicodeString;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.HSSFColor;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.BuiltinFormats;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.util.Internal;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.util.POILogFactory;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.util.POILogger;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.system.AbortReaderError;
 ...
 * @see com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
    ...
    */
     ...
     *
     * @see com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
