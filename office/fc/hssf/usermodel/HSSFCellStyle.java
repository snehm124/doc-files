...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.IFont;
...
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Workbook parentWorkbook) {
