...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.POIDocument;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.codec.DigestUtils;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherBSERecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherBitmapBlip;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherBlipRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ddf.EscherRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.OldExcelFormatException;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.FormulaShifter;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.formula.SheetNameFormatter;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.model.DrawingManager2;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.model.RecordStream;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.AbstractEscherHolderRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.RecordFactory;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.SSTRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.SubRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.CellReference;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.DirectoryNode;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.poifs.filesystem.POIFSFileSystem;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Workbook
{
...
//            names.add(name);
     ...
     */
    public int getSheetIndex(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.FormatRecord
     * @see Record
     */
