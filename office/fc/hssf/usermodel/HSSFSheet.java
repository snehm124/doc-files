...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.AutoFilterInfoRecord;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.CellValueRecordInterface;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.DVRecord;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.hssf.util.Region;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.SpreadsheetVersion;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.CellRange;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.DataValidation;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.DataValidationHelper;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.ICell;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.ICellStyle;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.IRow;
...
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.util.SSCellRange;
import com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.Sheet
{
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link com.documentreader.docs.pdf.word.document.reader.viewer.office.fc.ss.usermodel.com.wxiwei.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.com.wxiwei.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see com.documentreader.docs.pdf.word.document.reader.viewer.office.ss.model.baseModel.com.wxiwei.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
